...
final _sdkMapviewMapviewinternalTakescreenshotcallbackCopyHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_TakeScreenshotCallback_copy_handle'));
final _sdkMapviewMapviewinternalTakescreenshotcallbackReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_TakeScreenshotCallback_release_handle'));
final _sdkMapviewMapviewinternalTakescreenshotcallbackCreateProxy = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
class MapViewInternalTakeScreenshotCallback$Impl {
  ...
  void release() => _sdkMapviewMapviewinternalTakescreenshotcallbackReleaseHandle(handle);

  internalcall(Uint8List p0) {
    final _callFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapViewInternal_TakeScreenshotCallback_call__Blob'));
...
int _sdkMapviewMapviewinternalTakescreenshotcallbackcallStatic(int _token, Pointer<Void> p0) {
  
  try {
    (__lib.instanceCache[_token] as MapViewInternalTakeScreenshotCallback)(blobFromFfiNullable(p0));
  } finally {
...
Pointer<Void> sdkMapviewMapviewinternalTakescreenshotcallbackToFfi(MapViewInternalTakeScreenshotCallback value) {
  final result = _sdkMapviewMapviewinternalTakescreenshotcallbackCreateProxy(
    __lib.cacheObject(value),
    __lib.LibraryContext.isolateId,
    __lib.uncacheObjectFfi,
    Pointer.fromFunction<Int64 Function(Uint64, Pointer<Void>)>(_sdkMapviewMapviewinternalTakescreenshotcallbackcallStatic, __lib.unknownError)
  );

  return result;
}

MapViewInternalTakeScreenshotCallback sdkMapviewMapviewinternalTakescreenshotcallbackFromFfi(Pointer<Void> handle) {
  final _impl = MapViewInternalTakeScreenshotCallback$Impl(_sdkMapviewMapviewinternalTakescreenshotcallbackCopyHandle(handle));
  return (Uint8List p0) {
...
void sdkMapviewMapviewinternalTakescreenshotcallbackReleaseFfiHandle(Pointer<Void> handle) =>
  _sdkMapviewMapviewinternalTakescreenshotcallbackReleaseHandle(handle);

// Nullable MapViewInternalTakeScreenshotCallback

final _sdkMapviewMapviewinternalTakescreenshotcallbackCreateHandleNullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_TakeScreenshotCallback_create_handle_nullable'));
final _sdkMapviewMapviewinternalTakescreenshotcallbackReleaseHandleNullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_TakeScreenshotCallback_release_handle_nullable'));
final _sdkMapviewMapviewinternalTakescreenshotcallbackGetValueNullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_TakeScreenshotCallback_get_value_nullable'));

Pointer<Void> sdkMapviewMapviewinternalTakescreenshotcallbackToFfiNullable(MapViewInternalTakeScreenshotCallback value) {
  if (value == null) return Pointer<Void>.fromAddress(0);
  final _handle = sdkMapviewMapviewinternalTakescreenshotcallbackToFfi(value);
  final result = _sdkMapviewMapviewinternalTakescreenshotcallbackCreateHandleNullable(_handle);
  sdkMapviewMapviewinternalTakescreenshotcallbackReleaseFfiHandle(_handle);
  return result;
}

MapViewInternalTakeScreenshotCallback sdkMapviewMapviewinternalTakescreenshotcallbackFromFfiNullable(Pointer<Void> handle) {
  if (handle.address == 0) return null;
  final _handle = _sdkMapviewMapviewinternalTakescreenshotcallbackGetValueNullable(handle);
  final result = sdkMapviewMapviewinternalTakescreenshotcallbackFromFfi(_handle);
  sdkMapviewMapviewinternalTakescreenshotcallbackReleaseFfiHandle(_handle);
  return result;
}

void sdkMapviewMapviewinternalTakescreenshotcallbackReleaseFfiHandleNullable(Pointer<Void> handle) =>
  _sdkMapviewMapviewinternalTakescreenshotcallbackReleaseHandleNullable(handle);

// End of MapViewInternalTakeScreenshotCallback "private" section.

// MapViewInternal "private" section, not exported.

final _sdkMapviewMapviewinternalCopyHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_copy_handle'));
final _sdkMapviewMapviewinternalReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewInternal_release_handle'));
final _sdkMapviewMapviewinternalGetTypeId = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
class MapViewInternal$Impl extends __lib.NativeBase implements MapViewInternal {
  ...
  @override
  internaltakeScreenshot(MapViewInternalTakeScreenshotCallback callback) {
    final _takeScreenshotFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapViewInternal_takeScreenshot__TakeScreenshotCallback'));
    final _callbackHandle = sdkMapviewMapviewinternalTakescreenshotcallbackToFfi(callback);
    final _handle = this.handle;
    final __resultHandle = _takeScreenshotFfi(_handle, __lib.LibraryContext.isolateId, _callbackHandle);
    sdkMapviewMapviewinternalTakescreenshotcallbackReleaseFfiHandle(_callbackHandle);
    try {
      return (__resultHandle);
    } finally {
...
Pointer<Void> sdkMapviewMapviewinternalToFfiNullable(MapViewInternal value) =>
  value != null ? sdkMapviewMapviewinternalToFfi(value) : Pointer<Void>.fromAddress(0);

MapViewInternal sdkMapviewMapviewinternalFromFfiNullable(Pointer<Void> handle) =>
