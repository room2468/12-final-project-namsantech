...
class MapSceneLoadSceneCallback$Impl {
  ...
  call(MapError p0) {
    final _callFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapScene_LoadSceneCallback_call__MapError'));
...
int _sdkMapviewMapsceneLoadscenecallbackcallStatic(int _token, Pointer<Void> p0) {
  
  try {
    (__lib.instanceCache[_token] as MapSceneLoadSceneCallback)(sdkMapviewMaperrorFromFfiNullable(p0));
  } finally {
...
Pointer<Void> sdkMapviewMapsceneLoadscenecallbackToFfi(MapSceneLoadSceneCallback value) {
  final result = _sdkMapviewMapsceneLoadscenecallbackCreateProxy(
    ...
    Pointer.fromFunction<Int64 Function(Uint64, Pointer<Void>)>(_sdkMapviewMapsceneLoadscenecallbackcallStatic, __lib.unknownError)
  );
...
MapSceneLoadSceneCallback sdkMapviewMapsceneLoadscenecallbackFromFfi(Pointer<Void> handle) {
  final _impl = MapSceneLoadSceneCallback$Impl(_sdkMapviewMapsceneLoadscenecallbackCopyHandle(handle));
  return (MapError p0) {
...
class MapScene$Impl extends __lib.NativeBase implements MapScene {
  ...
  @override
  loadSceneForMapScheme(MapScheme mapScheme, MapSceneLoadSceneCallback callback) {
    final _loadSceneForMapSchemeFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Uint32, Pointer<Void>), void Function(Pointer<Void>, int, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapScene_loadScene__MapScheme_LoadSceneCallback'));
    ...
    final _handle = this.handle;
    final __resultHandle = _loadSceneForMapSchemeFfi(_handle, __lib.LibraryContext.isolateId, _mapSchemeHandle, _callbackHandle);
  ...
  @override
  loadSceneFromConfigurationFile(String configurationFile, MapSceneLoadSceneCallback callback) {
    final _loadSceneFromConfigurationFileFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_mapview_MapScene_loadScene__String_LoadSceneCallback'));
    final _configurationFileHandle = stringToFfi(configurationFile);
    final _callbackHandle = sdkMapviewMapsceneLoadscenecallbackToFfiNullable(callback);
    final _handle = this.handle;
    final __resultHandle = _loadSceneFromConfigurationFileFfi(_handle, __lib.LibraryContext.isolateId, _configurationFileHandle, _callbackHandle);
  ...
  loadSceneFromConfigurationFileWithWatermarkStyle(String configurationFile, WatermarkStyle watermarkStyle, MapSceneLoadSceneCallback callback) {
    ...
    final _callbackHandle = sdkMapviewMapsceneLoadscenecallbackToFfiNullable(callback);
    final _handle = this.handle;
    final __resultHandle = _loadSceneFromConfigurationFileWithWatermarkStyleFfi(_handle, __lib.LibraryContext.isolateId, _configurationFileHandle, _watermarkStyleHandle, _callbackHandle);
    stringReleaseFfiHandle(_configurationFileHandle);
  ...
  addMapPolyline(MapPolyline mapPolyline) {
    ...
    final _handle = this.handle;
    final __resultHandle = _addMapPolylineFfi(_handle, __lib.LibraryContext.isolateId, _mapPolylineHandle);
  ...
  removeMapPolyline(MapPolyline mapPolyline) {
    ...
    final _mapPolylineHandle = sdkMapviewMappolylineToFfi(mapPolyline);
    final _handle = this.handle;
    final __resultHandle = _removeMapPolylineFfi(_handle, __lib.LibraryContext.isolateId, _mapPolylineHandle);
    sdkMapviewMappolylineReleaseFfiHandle(_mapPolylineHandle);
    try {
      return (__resultHandle);
    } finally {
  ...
  addMapArrow(MapArrow mapArrow) {
    ...
    final _handle = this.handle;
    final __resultHandle = _addMapArrowFfi(_handle, __lib.LibraryContext.isolateId, _mapArrowHandle);
  ...
  removeMapArrow(MapArrow mapArrow) {
    ...
    final _mapArrowHandle = sdkMapviewMaparrowToFfi(mapArrow);
    final _handle = this.handle;
    final __resultHandle = _removeMapArrowFfi(_handle, __lib.LibraryContext.isolateId, _mapArrowHandle);
    sdkMapviewMaparrowReleaseFfiHandle(_mapArrowHandle);
    try {
      return (__resultHandle);
    } finally {
  ...
  addMapMarker(MapMarker marker) {
    ...
    final _handle = this.handle;
    final __resultHandle = _addMapMarkerFfi(_handle, __lib.LibraryContext.isolateId, _markerHandle);
  ...
  removeMapMarker(MapMarker marker) {
    ...
    final _markerHandle = sdkMapviewMapmarkerToFfi(marker);
    final _handle = this.handle;
    final __resultHandle = _removeMapMarkerFfi(_handle, __lib.LibraryContext.isolateId, _markerHandle);
    sdkMapviewMapmarkerReleaseFfiHandle(_markerHandle);
    try {
      return (__resultHandle);
    } finally {
  ...
  addMapMarker3d(MapMarker3D marker) {
    ...
    final _handle = this.handle;
    final __resultHandle = _addMapMarker3dFfi(_handle, __lib.LibraryContext.isolateId, _markerHandle);
  ...
  removeMapMarker3d(MapMarker3D marker) {
    ...
    final _markerHandle = sdkMapviewMapmarker3dToFfi(marker);
    final _handle = this.handle;
    final __resultHandle = _removeMapMarker3dFfi(_handle, __lib.LibraryContext.isolateId, _markerHandle);
    sdkMapviewMapmarker3dReleaseFfiHandle(_markerHandle);
    try {
      return (__resultHandle);
    } finally {
  ...
  addMapPolygon(MapPolygon mapPolygon) {
    ...
    final _handle = this.handle;
    final __resultHandle = _addMapPolygonFfi(_handle, __lib.LibraryContext.isolateId, _mapPolygonHandle);
  ...
  removeMapPolygon(MapPolygon mapPolygon) {
    ...
    final _mapPolygonHandle = sdkMapviewMappolygonToFfi(mapPolygon);
    final _handle = this.handle;
    final __resultHandle = _removeMapPolygonFfi(_handle, __lib.LibraryContext.isolateId, _mapPolygonHandle);
    sdkMapviewMappolygonReleaseFfiHandle(_mapPolygonHandle);
    try {
      return (__resultHandle);
    } finally {
  ...
  setLayerState(String layerName, MapSceneLayerState newState) {
    ...
    final _handle = this.handle;
    final __resultHandle = _setLayerStateFfi(_handle, __lib.LibraryContext.isolateId, _layerNameHandle, _newStateHandle);
