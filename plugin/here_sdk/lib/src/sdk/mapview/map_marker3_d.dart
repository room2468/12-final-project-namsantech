...
class MapMarker3D$Impl extends __lib.NativeBase implements MapMarker3D {
  ...
  MapMarker3D$Impl.$init(GeoCoordinates at, MapMarker3DModel model) : super(_$init(at, model)) {
    __lib.ffiCacheToken(handle, __lib.LibraryContext.isolateId, __lib.cacheObject(this));
  }


  MapMarker3D$Impl.withScale(GeoCoordinates at, MapMarker3DModel model, double scale) : super(_withScale(at, model, scale)) {
    __lib.ffiCacheToken(handle, __lib.LibraryContext.isolateId, __lib.cacheObject(this));
  }
  ...
  @override
  set metadata(Metadata value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapMarker3D_metadata_set__Metadata'));
