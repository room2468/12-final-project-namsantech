...
class Gestures$Impl extends __lib.NativeBase implements Gestures {
  ...
  enableDefaultAction(GestureType gestureType) {
    ...
    final __resultHandle = _enableDefaultActionFfi(_handle, __lib.LibraryContext.isolateId, _gestureTypeHandle);
  ...
  disableDefaultAction(GestureType gestureType) {
    ...
    final _gestureTypeHandle = sdkGesturesGesturetypeToFfi(gestureType);
    final _handle = this.handle;
    final __resultHandle = _disableDefaultActionFfi(_handle, __lib.LibraryContext.isolateId, _gestureTypeHandle);
    sdkGesturesGesturetypeReleaseFfiHandle(_gestureTypeHandle);
    try {
      return (__resultHandle);
    } finally {
  ...
  @override
  set tapListener(TapListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_tapListener_set__TapListener'));
  ...
  @override
  set doubleTapListener(DoubleTapListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_doubleTapListener_set__DoubleTapListener'));
  ...
  @override
  set pinchRotateListener(PinchRotateListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_pinchRotateListener_set__PinchRotateListener'));
  ...
  @override
  set longPressListener(LongPressListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_longPressListener_set__LongPressListener'));
  ...
  @override
  set panListener(PanListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_panListener_set__PanListener'));
  ...
  @override
  set twoFingerTapListener(TwoFingerTapListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_twoFingerTapListener_set__TwoFingerTapListener'));
  ...
  @override
  set twoFingerPanListener(TwoFingerPanListener value) {
    final _setFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_gestures_Gestures_twoFingerPanListener_set__TwoFingerPanListener'));
